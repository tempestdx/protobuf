...
type EnvironemntVariableType int32

const (
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_UNSPECIFIED EnvironemntVariableType = 0
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_VAR         EnvironemntVariableType = 1
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_SECRET      EnvironemntVariableType = 2
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_CERTIFICATE EnvironemntVariableType = 3
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_PRIVATE_KEY EnvironemntVariableType = 4
	EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_PUBLIC_KEY  EnvironemntVariableType = 5
)

// Enum value maps for EnvironemntVariableType.
var (
	EnvironemntVariableType_name = map[int32]string{
		0: "ENVIRONEMNT_VARIABLE_TYPE_UNSPECIFIED",
		1: "ENVIRONEMNT_VARIABLE_TYPE_VAR",
		2: "ENVIRONEMNT_VARIABLE_TYPE_SECRET",
		3: "ENVIRONEMNT_VARIABLE_TYPE_CERTIFICATE",
		4: "ENVIRONEMNT_VARIABLE_TYPE_PRIVATE_KEY",
		5: "ENVIRONEMNT_VARIABLE_TYPE_PUBLIC_KEY",
	}
	EnvironemntVariableType_value = map[string]int32{
		"ENVIRONEMNT_VARIABLE_TYPE_UNSPECIFIED": 0,
		"ENVIRONEMNT_VARIABLE_TYPE_VAR":         1,
		"ENVIRONEMNT_VARIABLE_TYPE_SECRET":      2,
		"ENVIRONEMNT_VARIABLE_TYPE_CERTIFICATE": 3,
		"ENVIRONEMNT_VARIABLE_TYPE_PRIVATE_KEY": 4,
		"ENVIRONEMNT_VARIABLE_TYPE_PUBLIC_KEY":  5,
	}
)

func (x EnvironemntVariableType) Enum() *EnvironemntVariableType {
	p := new(EnvironemntVariableType)
	*p = x
	return p
}

func (x EnvironemntVariableType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnvironemntVariableType) Descriptor() protoreflect.EnumDescriptor {
	return file_tempestdx_app_v1_app_proto_enumTypes[5].Descriptor()
}

func (EnvironemntVariableType) Type() protoreflect.EnumType {
	return &file_tempestdx_app_v1_app_proto_enumTypes[5]
}

func (x EnvironemntVariableType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnvironemntVariableType.Descriptor instead.
func (EnvironemntVariableType) EnumDescriptor() ([]byte, []int) {
...
type EnvironemntVariable struct {
	...
	Type EnvironemntVariableType `protobuf:"varint,3,opt,name=type,proto3,enum=tempestdx.app.v1.EnvironemntVariableType" json:"type,omitempty"`
}
...
func (x *EnvironemntVariable) GetType() EnvironemntVariableType {
	if x != nil {
		return x.Type
	}
	return EnvironemntVariableType_ENVIRONEMNT_VARIABLE_TYPE_UNSPECIFIED
}
...
type Resource struct {
	...
	EnvironmentVariables []*EnvironemntVariable `protobuf:"bytes,6,rep,name=environment_variables,json=environmentVariables,proto3" json:"environment_variables,omitempty"`
}
...
func (x *Resource) GetEnvironmentVariables() []*EnvironemntVariable {
	if x != nil {
...
var file_tempestdx_app_v1_app_proto_rawDesc = []byte{
	...
	0x6b, 0x0a, 0x10, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x57, 0x0a, 0x14, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x64, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x24, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78, 0x2e, 0x61, 0x70,
	0x70, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x65, 0x66,
	0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x13, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x28, 0x0a, 0x12,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x6c, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x5e, 0x0a, 0x04, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x10, 0x0a, 0x03,
	0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x14,
	0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74,
	0x69, 0x74, 0x6c, 0x65, 0x12, 0x2e, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78, 0x2e, 0x61,
	0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x22, 0xe5, 0x01, 0x0a, 0x10, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44,
	...
	0x6d, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63,
	0x74, 0x52, 0x0b, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x3c,
	...
	0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xb5, 0x06, 0x0a,
	0x12, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x12, 0x2f, 0x0a, 0x06, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78, 0x2e,
	0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x77,
	0x6e, 0x65, 0x72, 0x73, 0x12, 0x2f, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78,
	0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x06, 0x61,
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x22, 0x62, 0x0a, 0x05, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x14,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74,
	0x64, 0x78, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	0x6e, 0x65, 0x6d, 0x6e, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xa5, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f,
	...
	0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x69, 0x73,
	0x70, 0x6c, 0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2c, 0x0a, 0x05,
	0x6c, 0x69, 0x6e, 0x6b, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x65,
	0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4c,
	0x69, 0x6e, 0x6b, 0x52, 0x05, 0x6c, 0x69, 0x6e, 0x6b, 0x73, 0x12, 0x37, 0x0a, 0x0a, 0x70, 0x72,
	...
	0x69, 0x65, 0x73, 0x12, 0x5a, 0x0a, 0x15, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65,
	0x6e, 0x74, 0x5f, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x25, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64, 0x78, 0x2e, 0x61,
	0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x65, 0x6d, 0x6e,
	...
	0x83, 0x02, 0x0a, 0x1f, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74, 0x64,
	0x78, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x36, 0x0a, 0x08, 0x72,
	...
	0x72, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74,
	0x64, 0x78, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x6f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x18,
	...
	,
	...
	,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x65, 0x73, 0x74,
	0x64, 0x78, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x36, 0x0a, 0x08,
	...
	0x75, 0x72, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x65, 0x78, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x65, 0x78, 0x74, 0x22, 0x65, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74,
	...
	,
	...
	,
	...
	,
}
...
var file_tempestdx_app_v1_app_proto_goTypes = []any{
	...
	(EnvironemntVariableType)(0),             // 5: tempestdx.app.v1.EnvironemntVariableType
...
var file_tempestdx_app_v1_app_proto_depIdxs = []int32{
	...
	5,  // 14: tempestdx.app.v1.EnvironemntVariable.type:type_name -> tempestdx.app.v1.EnvironemntVariableType
	...
	15, // 17: tempestdx.app.v1.Resource.environment_variables:type_name -> tempestdx.app.v1.EnvironemntVariable
	13, // 18: tempestdx.app.v1.ExecuteResourceOperationRequest.metadata:type_name -> tempestdx.app.v1.Metadata
	16, // 19: tempestdx.app.v1.ExecuteResourceOperationRequest.resource:type_name -> tempestdx.app.v1.Resource
	4,  // 20: tempestdx.app.v1.ExecuteResourceOperationRequest.operation:type_name -> tempestdx.app.v1.ResourceOperation
	23, // 21: tempestdx.app.v1.ExecuteResourceOperationRequest.input:type_name -> google.protobuf.Struct
	...
	23, // 26: tempestdx.app.v1.ExecuteResourceActionResponse.output:type_name -> google.protobuf.Struct
	13, // 27: tempestdx.app.v1.ListResourcesRequest.metadata:type_name -> tempestdx.app.v1.Metadata
	16, // 28: tempestdx.app.v1.ListResourcesRequest.resource:type_name -> tempestdx.app.v1.Resource
	16, // 29: tempestdx.app.v1.ListResourcesResponse.resources:type_name -> tempestdx.app.v1.Resource
	6,  // 30: tempestdx.app.v1.AppService.Describe:input_type -> tempestdx.app.v1.DescribeRequest
	8,  // 31: tempestdx.app.v1.AppService.HealthCheck:input_type -> tempestdx.app.v1.HealthCheckRequest
	17, // 32: tempestdx.app.v1.AppService.ExecuteResourceOperation:input_type -> tempestdx.app.v1.ExecuteResourceOperationRequest
	21, // 33: tempestdx.app.v1.AppService.ListResources:input_type -> tempestdx.app.v1.ListResourcesRequest
	19, // 34: tempestdx.app.v1.AppService.ExecuteResourceAction:input_type -> tempestdx.app.v1.ExecuteResourceActionRequest
	7,  // 35: tempestdx.app.v1.AppService.Describe:output_type -> tempestdx.app.v1.DescribeResponse
	9,  // 36: tempestdx.app.v1.AppService.HealthCheck:output_type -> tempestdx.app.v1.HealthCheckResponse
	18, // 37: tempestdx.app.v1.AppService.ExecuteResourceOperation:output_type -> tempestdx.app.v1.ExecuteResourceOperationResponse
	22, // 38: tempestdx.app.v1.AppService.ListResources:output_type -> tempestdx.app.v1.ListResourcesResponse
	20, // 39: tempestdx.app.v1.AppService.ExecuteResourceAction:output_type -> tempestdx.app.v1.ExecuteResourceActionResponse
